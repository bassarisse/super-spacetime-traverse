...
public class SpawnBehavior : MonoBehaviour {
	...
	[Header("General")]
	public Vector2 area = new Vector2(0, 0);
	public GameObject[] spawnObjects = new GameObject[0];

	[Header("Speed Settings")]
	public Vector2 minSpawnSpeed = new Vector2(1, 0);
	...
	void SetupObject(GameObject obj) {
		...
		if (c != null) {
			c.Speed = new Vector2 (Random.Range (minSpawnSpeed.x, maxSpawnSpeed.x), Random.Range (minSpawnSpeed.y, maxSpawnSpeed.y));
		}
